 ...
 * \file narray_operator.cc
 * \brief the implementation of narray operator
 * \author Naiyan Wang
 */
#include <mxnet/narray_operator.h>
 
namespace mxnet {

  NArrayOperator::NArrayOperator(Operator* op, Context ctx) {
    this->op = op;
    this->global_ctx = ctx;
  }
  /*!
   ...
   */
  std::vector<ArgType> NArrayOperator::DescribeArgs() const {
   ...
   */
  int NArrayOperator::DescribeProperty() const {
   ...
   */
  void NArrayOperator::SetParam(const char *name, const char *val) {
   ...
   */
  void NArrayOperator::InferShape(std::vector<TShape> *in_shape,
   ...
   */
  void NArrayOperator::Forward(Option opt,
                       RunContext ctx,
   ...
   * \sa GradReqType
   */
  void NArrayOperator::Backward(RunContext ctx,
  ...
  void NArrayOperator::SetContext(Context ctx) {
    this->global_ctx = ctx;
  }
