...
const std::map<std::string, std::vector<std::vector<std::string>>> ops_desc = {
  ...
  {"_plus_scalar"                      , {{"op::add(%, %)", "_0", "scalar"}}},
  {"_PlusScalar"                       , {{"op::add(%, %)", "_0", "scalar"}}},
  {"_minus_scalar"                     , {{"op::sub(%, %)", "_0", "scalar"}}},
  {"_MinusScalar"                      , {{"op::sub(%, %)", "_0", "scalar"}}},
  {"_rminus_scalar"                    , {{"(-op::sub(%, %))", "_0", "scalar"}}},
  {"_RMinusScalar"                     , {{"(-op::sub(%, %))", "_0", "scalar"}}},
  {"_mul_scalar"                       , {{"op::mul(%, %)", "_0", "scalar"}}},
  {"_MulScalar"                        , {{"op::mul(%, %)", "_0", "scalar"}}},
  {"_div_scalar"                       , {{"op::div(%, %)", "_0", "scalar"}}},
  {"_DivScalar"                        , {{"op::div(%, %)", "_0", "scalar"}}},
  {"_rdiv_scalar"                      , {{"op::rdiv(%, %)", "_0", "scalar"}}},
  {"_power_scalar"                     , {{"op::power(%, %)", "_0", "scalar"}}},
  {"_PowerScalar"                      , {{"op::power(%, %)", "_0", "scalar"}}},
  {"_rpower_scalar"                    , {{"op::rpow(%, %)", "_0", "scalar"}}},
  {"_RPowerScalar"                     , {{"op::rpow(%, %)", "_0", "scalar"}}},
  {"_RDivScalar"                       , {{"op::rdiv(%, %)", "_0", "scalar"}}},
  ...
  {"_hypot_scalar"                     , {{"op::hypot(%, %)", "_0", "scalar"}}},
  ...
  {"_backward_hypot_scalar"            , {{"(% * % / op::hypot(%, %))",
                                           "_0", "_1", "_1", "scalar"}}},
  ...
  {"_backward_clip"                    , {{"op::backward_clip(%, %, %, %)", "_1", "_0",
                                                                            "a_min", "a_max"}}},
  {"smooth_l1"                         , {{"op::smooth_l1(%, %)", "_0", "scalar"}}},
  {"_backward_smooth_l1"               , {{"op::backward_smooth_l1(%, %, %)",
                                           "_1", "scalar", "_0"}}},
  // TODO(ptredak): arange
