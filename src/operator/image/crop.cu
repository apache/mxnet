...
NNVM_REGISTER_OP(_image_crop).set_attr<FCompute>("FCompute<gpu>", CropOpForward<gpu>);

NNVM_REGISTER_OP(_backward_image_crop).set_attr<FCompute>("FCompute<gpu>", CropOpBackward<gpu>);

NNVM_REGISTER_OP(_image_random_crop).set_attr<FCompute>("FCompute<gpu>", RandomCropOpForward<gpu>);
