...
IMPLEMENT_UNARY_WORKLOAD_FWD(mxnet::op::mshadow_op::logcdf_normal);  // NOLINT()
IMPLEMENT_UNARY_WORKLOAD_BWD(mxnet::op::mshadow_op::logcdf_normal_grad);  // NOLINT()
IMPLEMENT_UNARY_WORKLOAD_FWD(mxnet::op::mshadow_op::derivlogcdf_normal);  // NOLINT()
IMPLEMENT_UNARY_WORKLOAD_BWD(mxnet::op::mshadow_op::derivlogcdf_normal_grad);  // NOLINT()
