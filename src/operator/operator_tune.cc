...
IMPLEMENT_BLANK_WORKLOAD_FWD(mxnet::op::mshadow_op::logaddexp2);
IMPLEMENT_BLANK_WORKLOAD_BWD(mxnet::op::mshadow_op::logaddexp2_grad_left);
IMPLEMENT_BLANK_WORKLOAD_BWD(mxnet::op::mshadow_op::logaddexp2_grad_right);
/*!
