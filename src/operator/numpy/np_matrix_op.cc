...
.set_attr<mxnet::FInferShape>("FInferShape", NumpySliceOpShape)
.set_attr<nnvm::FInferType>("FInferType", ElemwiseType<1, 1>)
...
.set_attr<FCompute>("FCompute<cpu>", NumpySliceOpForward<cpu>)
...
.set_attr_parser(ParamParser<SliceParam>)
.set_attr<nnvm::TIsBackward>("TIsBackward", true)
.set_attr<FCompute>("FCompute<cpu>", NumpySliceOpBackward<cpu>);
