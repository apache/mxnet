 ...
 * \file np_insert_op_tensor_indices.cc
...
DMLC_REGISTER_PARAMETER(NumpyInsertTensorParam);

bool NumpyInsertTensorIndicesType(const nnvm::NodeAttrs& attrs,
...
bool NumpyInsertTensorIndicesShape(const nnvm::NodeAttrs& attrs,
...
.set_attr<mxnet::FInferShape>("FInferShape", NumpyInsertTensorIndicesShape)
.set_attr<nnvm::FInferType>("FInferType", NumpyInsertTensorIndicesType)
.set_attr<mxnet::FCompute>("FCompute<cpu>", NumpyInsertTensorIndicesCompute<cpu>)
