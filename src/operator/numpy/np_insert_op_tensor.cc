...
.set_attr_parser(ParamParser<NumpyInsertTensorParam>)
.set_num_inputs([](const NodeAttrs& attrs) {
    const NumpyInsertTensorParam& params = nnvm::get<NumpyInsertTensorParam>(attrs.parsed);
...
.add_arguments(NumpyInsertTensorParam::__FIELDS__());
