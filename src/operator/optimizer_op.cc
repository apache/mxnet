...
.set_attr<FInferStorageType>("FInferStorageType", ElemwiseStorageType<2, 1, true, false>)
...
.set_attr<FInferStorageType>("FInferStorageType", ElemwiseStorageType<3, 1, true, false>)
