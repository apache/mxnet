...
.set_attr<FCompute>("FCompute<gpu>", BinaryCompute<gpu, unary_backward<mshadow_op::sign> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryCompute<gpu, unary_backward<mshadow_op::sign_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryCompute<gpu, unary_backward<mshadow_op::square_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryCompute<gpu, unary_backward<mshadow_op::square_root_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryCompute<gpu, unary_backward<mshadow_op::log_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryCompute<gpu, unary_backward<mshadow_op::cos_grad> >);
...
.set_attr<FCompute>("FCompute<gpu>", BinaryCompute<gpu, unary_backward<mshadow_op::sin_grad> >);
