...
.set_attr<FCompute>("FCompute<cpu>", BinaryScalarOp::BinaryScalarCompute<cpu, mshadow_op::maximum>)
...
.set_attr<FCompute>("FCompute<cpu>", BinaryScalarOp::BinaryScalarBackward<cpu, mshadow_op::ge>);

MXNET_OPERATOR_REGISTER_BINARY_SCALAR(_minimum_scalar)
.set_attr<FCompute>("FCompute<cpu>", BinaryScalarOp::BinaryScalarCompute<cpu, mshadow_op::minimum>)
...
.add_argument("scalar", "float", "scalar value")
.set_attr_parser([](NodeAttrs* attrs) {attrs->parsed = std::stod(attrs->dict["scalar"]);})
.set_attr<FCompute>("FCompute<cpu>", BinaryScalarOp::BinaryScalarBackward<cpu, mshadow_op::le>);

MXNET_OPERATOR_REGISTER_BINARY_SCALAR(_power_scalar)
.set_attr<FCompute>("FCompute<cpu>", BinaryScalarOp::BinaryScalarCompute<cpu, mshadow_op::power>)
...
.set_attr<FCompute>("FCompute<cpu>", BinaryScalarOp::BinaryScalarCompute<
