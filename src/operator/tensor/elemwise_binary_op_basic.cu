...
.set_attr<FCompute>("FCompute<gpu>",
                    VectorizedBackwardUseInCompute<mshadow_op::right,
                    mshadow_op::left>);
...
.set_attr<FCompute>("FCompute<gpu>",
                    VectorizedBackwardUseInCompute<mshadow_op::div_grad,
...
.set_attr<FCompute>("FCompute<gpu>",
  VectorizedBackwardUseInCompute<mshadow_op::mod_grad, mshadow_op::mod_rgrad>);
