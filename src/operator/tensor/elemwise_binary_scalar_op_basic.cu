...
.set_attr<FCompute>("FCompute<gpu>", VectorizedCompute<mshadow_op::rminus>);
...
.set_attr<FCompute>("FCompute<gpu>", VectorizedCompute<op::mshadow_op::div>)
...
.set_attr<FCompute>("FCompute<gpu>", VectorizedCompute<mshadow_op::rdiv>);

NNVM_REGISTER_OP(_backward_rdiv_scalar)
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::rdiv_grad>);
...
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::mod_grad>);

NNVM_REGISTER_OP(_rmod_scalar)
.set_attr<FCompute>("FCompute<gpu>", VectorizedCompute<mshadow_op::rmod>);

NNVM_REGISTER_OP(_backward_rmod_scalar)
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::rmod_grad>);
