...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::rdiv_grad>);
...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::mod_grad>);
...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::rmod_grad>);
