...
NNVM_REGISTER_OP(_backward_power)
    ...
    .set_attr<FCompute>(
        "FCompute<cpu>",
        ElemwiseBinaryOp::BackwardUseIn<cpu, mshadow_op::power_grad, mshadow_op::power_rgrad>);
...
NNVM_REGISTER_OP(_backward_maximum)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        ElemwiseBinaryOp::BackwardUseIn<cpu, mshadow_op::ge, mshadow_op::lt>);
...
NNVM_REGISTER_OP(_backward_minimum)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        ElemwiseBinaryOp::BackwardUseIn<cpu, mshadow_op::le, mshadow_op::gt>);
...
NNVM_REGISTER_OP(_backward_hypot)
    ...
    .set_attr<FCompute>("FCompute<cpu>",
                        ElemwiseBinaryOp::BackwardUseIn<cpu,
