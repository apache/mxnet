...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseNone{"_copy"})
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseNone{"negative"})
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseNone{"_mul_scalar"})
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseNone{"_div_scalar"})
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_rdiv_scalar"})
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_maximum_scalar"})
.add_alias("_MaximumScalar");

MXNET_OPERATOR_REGISTER_BINARY(_backward_maximum_scalar)
.add_argument("scalar", "float", "scalar value")
.set_attr_parser([](NodeAttrs* attrs) {attrs->parsed = std::stod(attrs->dict["scalar"]);})
.set_attr<FCompute>("FCompute<cpu>", BinaryScalarBackward<cpu, mshadow_op::maximum_grad>);
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_minimum_scalar"})
.add_alias("_MinimumScalar");

MXNET_OPERATOR_REGISTER_BINARY(_backward_minimum_scalar)
.add_argument("scalar", "float", "scalar value")
.set_attr_parser([](NodeAttrs* attrs) {attrs->parsed = std::stod(attrs->dict["scalar"]);})
.set_attr<FCompute>("FCompute<cpu>", BinaryScalarBackward<cpu, mshadow_op::minimum_grad>);
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_power_scalar"})
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseOut{"_backward_rpower_scalar"})
