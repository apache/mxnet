...
struct ZeroTriangular {
  ...
  MSHADOW_XINLINE static void Map(index_t i,
                                  ...
                                  bool zero_lower) {
    const index_t row((i % matrix_size) / stride), col(i % stride);
    if ((!zero_lower && (row < col)) || (zero_lower && (row > col)))
      data[i] = 0;
  }
};
struct Scale {
...
struct gemm {
  ...
  static void op(const Tensor<xpu, dim, DType>& A,
  ...
  static void op(const Tensor<xpu, dim, DType>& A,
                 const Tensor<xpu, dim, DType>& B,
                 const Tensor<xpu, dim, DType>& C,
                 const Tensor<xpu, dim, DType>& D,
                 Stream<xpu>* s,
                 const nnvm::NodeAttrs& attrs) {
    if (C.dptr_ != D.dptr_)
      Copy(D, C, s);
    const LaMatrixMacParam& param = nnvm::get<LaMatrixMacParam>(attrs.parsed);
    op(A, B, D, DType(param.alpha), DType(param.beta), param.transpose_a, param.transpose_b, s);
  }
  template <typename xpu, int dim, typename DType>
  static void op(const Tensor<xpu, dim, DType>& A,
                 const Tensor<xpu, dim, DType>& B,
...
struct potrf {
  ...
  static void op(const Tensor<xpu, 3, DType>& A,
    ...
    Kernel<ZeroTriangular, xpu>::Launch(
        s, B.MSize(), B.size(1) * B.stride_, B.stride_, B.dptr_, !param.lower);
  }
  template <typename xpu, typename DType>
  static void op(const Tensor<xpu, 3, DType>& A,
                 const Tensor<xpu, 3, DType>& B,
...
struct potri {
  template <typename xpu, typename DType>
  static void op(const Tensor<xpu, 3, DType>& B,
    ...
    Kernel<CopyTriangularToOppositeSide, xpu>::Launch(
        s, A.MSize(), A.size(1) * A.stride_, A.stride_, A.dptr_, !param.lower);
  }
  template <typename xpu, typename DType>
  static void op(const Tensor<xpu, 3, DType>& B,
                 const Tensor<xpu, 3, DType>& A,
...
struct copytrian {
  ...
  static void op(const Tensor<xpu, 3, DType>& A,
    ...
    Kernel<CopyTrian<true>, xpu>::Launch(
        s, A.MSize(), param.lower, param.offset, A.size(1), A.dptr_, B.dptr_);
  }
  ...
  static void op(const Tensor<xpu, 2, DType>& A,
    ...
    const LaTrianParam& param = nnvm::get<LaTrianParam>(attrs.parsed);
    Kernel<set_zero, xpu>::Launch(s, B.MSize(), B.dptr_);
    Kernel<CopyTrian<false>, xpu>::Launch(
        s, B.MSize(), param.lower, param.offset, B.size(1), A.dptr_, B.dptr_);
  }
};
...
struct syrk {
  ...
  static void op(const Tensor<xpu, 3, DType>& A,
    ...
    using namespace mxnet_op;
    Kernel<CopyTriangularToOppositeSide, xpu>::Launch(
        s, B.MSize(), B.size(1) * B.stride_, B.stride_, B.dptr_, false);
  }
  template <typename xpu, typename DType>
  static void op(const Tensor<xpu, 3, DType>& A,
                 const Tensor<xpu, 3, DType>& B,
...
struct gelqf {
  ...
  static void op(const Tensor<xpu, 3, DType>& A,
    ...
    Tensor<xpu, 1, DType> work =
        ctx.requested[0].get_space_typed<xpu, 1, DType>(Shape1(ws_size), s);
    ...
    for (index_t i = 0; i < A.size(0); ++i) {
      ...
      using namespace mxnet_op;
      Kernel<ZeroTriangular, xpu>::Launch(
          s, Li.MSize(), m * Li.stride_, Li.stride_, Li.dptr_, false);
...
struct syevd {
  ...
  static void op(const Tensor<xpu, 3, DType>& A,
    ...
    Tensor<xpu, 1, DType> work = ctx.requested[0].get_space_typed<xpu, 1, DType>(Shape1(lwork), s);
    // Loop over items in batch
...
struct det {
  ...
  static void op(const Tensor<xpu, 3, DType>& A,
    ...
    Stream<xpu>* s             = ctx.get_stream<xpu>();
    Tensor<xpu, 1, DType> sign = ctx.requested[0].get_space_typed<xpu, 1, DType>(det.shape_, s);
    Copy(LU, A, s);
    ...
    Kernel<SignedLogDet, xpu>::Launch(
        s, pivot.size(0), pivot.size(1), pivot.dptr_, LU.dptr_, sign.dptr_, det.dptr_);
...
struct slogdet {
  ...
  static void op(const Tensor<xpu, 3, DType>& A,
    ...
    Kernel<SignedLogDet, xpu>::Launch(
        s, pivot.size(0), pivot.size(1), pivot.dptr_, LU.dptr_, sign.dptr_, logabsdet.dptr_);
  }
};
...
struct gemm_backward {
  template <typename xpu, int dim, typename DType>
  static void op(const Tensor<xpu, dim, DType>& dD,
                 const Tensor<xpu, dim, DType>& A,
                 const Tensor<xpu, dim, DType>& B,
                 const Tensor<xpu, dim, DType>& C,
                 const Tensor<xpu, dim, DType>& dA,
...
struct potrf_backward {
  template <typename xpu, typename DType>
  static void op(const Tensor<xpu, 3, DType>& dB,
                 const Tensor<xpu, 3, DType>& B,
...
struct potri_backward {
  ...
  static void op(const Tensor<xpu, 3, DType>& dA,
    ...
    using namespace mxnet_op;
    Kernel<ZeroTriangular, xpu>::Launch(
        s, dB.MSize(), dB.size(1) * dB.stride_, dB.stride_, dB.dptr_, !param.lower);
  }
  template <typename xpu, typename DType>
  static void op(const Tensor<xpu, 3, DType>& dA,
                 const Tensor<xpu, 3, DType>& B,
...
struct trsm_backward {
  template <typename xpu, typename DType>
  static void op(const Tensor<xpu, 3, DType>& dC,
                 const Tensor<xpu, 3, DType>& A,
                 const Tensor<xpu, 3, DType>& B,
                 const Tensor<xpu, 3, DType>& C,
                 const Tensor<xpu, 3, DType>& dA,
...
struct gelqf_backward {
  ...
  static void op(const Tensor<xpu, 3, DType>& dQ,
    ...
    Tensor<xpu, 3, DType> tempM = ctx.requested[0].get_space_typed<xpu, 3, DType>(dL.shape_, s);
    Copy(tempM, dL, s);
    trmm::op(L, tempM, DType(1.0), false, true, true, s);
    gemm::op(dA, Q, tempM, DType(-1.0), DType(1.0), false, true, s);
    Kernel<CopyTriangularToOppositeSide, xpu>::Launch(
        s, tempM.MSize(), tempM.size(1) * tempM.stride_, tempM.stride_, tempM.dptr_, false);
...
struct SyevdBackHelper {
  ...
  Map(int k, int n, DType* X, int ldx, DType* L, int ldl, DType* dL, int lddl, DType* Y, int ldy) {
...
struct syevd_backward {
  ...
  static void op(const Tensor<xpu, 3, DType>& dU,
    ...
    Tensor<xpu, 3, DType> tempM = ctx.requested[0].get_space_typed<xpu, 3, DType>(dA.shape_, s);
    ...
    Kernel<SyevdBackHelper, xpu>::Launch(s,
                                         dA.size(0),
                                         dA.size(1),
                                         tempM.dptr_,
                                         tempM.stride_,
...
struct inverse_backward {
  ...
  static void op(const Tensor<xpu, 3, DType>& dA,
    ...
    Stream<xpu>* s             = ctx.get_stream<xpu>();
    Tensor<xpu, 3, DType> temp = ctx.requested[0].get_space_typed<xpu, 3, DType>(A.shape_, s);
...
struct det_backward {
  ...
  static void op(const Tensor<xpu, 1, DType>& ddet,
    ...
    const_cast<Tensor<xpu, 3, DType>&>(dA) =
        broadcast_to(reshape(det * ddet, Shape3(det.size(0), 1, 1)), mxnet::TShape(LU.shape_)) *
        transpose(LU, Shape3(0, 2, 1));
    // stop grad for zero det temporarily
    Kernel<StopZeroDetGrad, xpu>::Launch(
        s, dA.shape_.Size(), dA.size(1) * dA.size(2), dA.dptr_, det.dptr_, DType(0));
  }
};
...
struct slogdet_backward {
  ...
  static void op(const Tensor<xpu, 1, DType>& dlogabsdet,
    ...
    const_cast<Tensor<xpu, 3, DType>&>(dA) =
        broadcast_to(reshape(dlogabsdet, Shape3(logabsdet.size(0), 1, 1)),
                     mxnet::TShape(LU.shape_)) *
        transpose(LU, Shape3(0, 2, 1));
    // stop grad for zero det
    Kernel<StopZeroDetGrad, xpu>::Launch(
        s, dA.shape_.Size(), dA.size(1) * dA.size(2), dA.dptr_, logabsdet.dptr_, DType(-INFINITY));
  }
};
