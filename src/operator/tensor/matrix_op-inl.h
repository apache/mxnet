...
// inline void Transpose2D_gpu(const DType *in, DType *out, index_t row, index_t col);
/*!
...
//MSHADOW_XINLINE void Transpose2D<cpu>(const DType *in, DType *out, index_t row, index_t col) {
