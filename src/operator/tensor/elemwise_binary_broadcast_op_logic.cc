...
.describe(R"code(Returns the result of element-wise "greater than equal to"(>=) comparison operation with broadcasting.
...
.describe(R"code(Returns the result of element-wise "lesser than equal to"(<=) comparison operation with broadcasting.
