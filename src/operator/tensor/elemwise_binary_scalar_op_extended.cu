...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::ge>);
...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::le>);
...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::power_grad>);
...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::rpower_grad>);
...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::hypot_grad_left>);
...
.set_attr<FCompute>("FCompute<gpu>", binary_scalar::VectorizedBwdCompute<mshadow_op::smooth_l1_gradient>);
