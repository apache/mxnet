...
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::ge>);
...
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::le>);
...
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::power_grad>);

NNVM_REGISTER_OP(_rpower_scalar)
.set_attr<FCompute>("FCompute<gpu>", VectorizedCompute<mshadow_op::rpower>);

NNVM_REGISTER_OP(_backward_rpower_scalar)
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::rpower_grad>);
...
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::hypot_grad_left>);

NNVM_REGISTER_OP(smooth_l1)
.set_attr<FCompute>("FCompute<gpu>", VectorizedCompute<mshadow_op::smooth_l1_loss>);

NNVM_REGISTER_OP(_backward_smooth_l1)
.set_attr<FCompute>("FCompute<gpu>", VectorizedBwdCompute<mshadow_op::smooth_l1_gradient>);
