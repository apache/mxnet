...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_abs"});

MXNET_OPERATOR_REGISTER_BINARY(_backward_abs)
.set_attr<FCompute>("FCompute<cpu>", BinaryCompute<cpu, unary_backward<mshadow_op::sign> >);
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_sign"});

MXNET_OPERATOR_REGISTER_BINARY(_backward_sign)
.set_attr<FCompute>("FCompute<cpu>", BinaryCompute<cpu, unary_backward<mshadow_op::sign_grad> >);
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_square"});

MXNET_OPERATOR_REGISTER_BINARY(_backward_square)
.set_attr<FCompute>("FCompute<cpu>", BinaryCompute<cpu, unary_backward<mshadow_op::square_grad> >);
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseOut{"_backward_sqrt"});

MXNET_OPERATOR_REGISTER_BINARY(_backward_sqrt)
.set_attr<FCompute>("FCompute<cpu>", BinaryCompute<cpu, unary_backward<mshadow_op::square_root_grad> >);
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_rsqrt"});
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseOut{"_mul"});
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_log"});

MXNET_OPERATOR_REGISTER_BINARY(_backward_log)
.set_attr<FCompute>("FCompute<cpu>", BinaryCompute<cpu, unary_backward<mshadow_op::log_grad> >);
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_cos"});

MXNET_OPERATOR_REGISTER_BINARY(_backward_cos)
.set_attr<FCompute>("FCompute<cpu>", BinaryCompute<cpu, unary_backward<mshadow_op::cos_grad> >);
...
.set_attr<nnvm::FGradient>("FGradient", UnaryGradUseIn{"_backward_sin"});

MXNET_OPERATOR_REGISTER_BINARY(_backward_sin)
.set_attr<FCompute>("FCompute<cpu>", BinaryCompute<cpu, unary_backward<mshadow_op::sin_grad> >);
