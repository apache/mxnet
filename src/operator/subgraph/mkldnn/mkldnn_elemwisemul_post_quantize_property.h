...
#ifndef MXNET_OPERATOR_SUBGRAPH_MKLDNN_MKLDNN_ELTWISEMUL_POST_QUANTIZE_PROPERTY_H_
#define MXNET_OPERATOR_SUBGRAPH_MKLDNN_MKLDNN_ELTWISEMUL_POST_QUANTIZE_PROPERTY_H_
...
#endif  // MXNET_OPERATOR_SUBGRAPH_MKLDNN_MKLDNN_ELTWISEMUL_POST_QUANTIZE_PROPERTY_H_
