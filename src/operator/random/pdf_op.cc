...
#define MXNET_OPERATOR_REGISTER_PDF(distr,                                                     \
                                    pdffunc,                                                   \
                                    num_parms,                                                 \
                                    parm_name_1,                                               \
                                    parm_name_2,                                               \
...
#define MXNET_OPERATOR_REGISTER_PDF_GRAD(distr, pdffunc, num_parms, vectorparms) \
  NNVM_REGISTER_OP(_backward_pdf_##distr)                                        \
      ...
      .set_attr<FCompute>("FCompute<cpu>",                                       \
                          PdfOpBackward<cpu, pdffunc##_Grad, num_parms, vectorparms>);

#define MXNET_OPERATOR_REGISTER_PDF1(                                                           \
    distr, pdffunc, parm_name, parm_desc, description, vectorparms)                             \
  MXNET_OPERATOR_REGISTER_PDF(                                                                  \
      distr, pdffunc, 1, parm_name, parm_name, parm_desc, parm_desc, description, vectorparms); \
  MXNET_OPERATOR_REGISTER_PDF_GRAD(distr, pdffunc, 1, vectorparms)

#define MXNET_OPERATOR_REGISTER_PDF2(                                                            \
    distr, pdffunc, parm_name_1, parm_name_2, parm_desc_1, parm_desc_2, description)             \
  MXNET_OPERATOR_REGISTER_PDF(                                                                   \
      distr, pdffunc, 2, parm_name_1, parm_name_2, parm_desc_1, parm_desc_2, description, false) \
...
MXNET_OPERATOR_REGISTER_PDF2(uniform,
                             PDF_Uniform,
                             "low",
                             "high",
                             ...
                             uniform_desc)
MXNET_OPERATOR_REGISTER_PDF2(normal,
                             PDF_Normal,
                             "mu",
                             "sigma",
                             ...
                             normal_desc)
MXNET_OPERATOR_REGISTER_PDF2(gamma,
                             PDF_Gamma,
                             "alpha",
                             "beta",
                             ...
                             gamma_desc)
MXNET_OPERATOR_REGISTER_PDF1(exponential,
                             PDF_Exponential,
                             "lam",
                             "Lambda (rate) parameters of the distributions.",
                             exponential_desc,
                             false)
MXNET_OPERATOR_REGISTER_PDF1(poisson,
                             PDF_Poisson,
                             "lam",
                             "Lambda (rate) parameters of the distributions.",
                             poisson_desc,
                             false)
MXNET_OPERATOR_REGISTER_PDF2(negative_binomial,
                             PDF_NegativeBinomial,
                             "k",
                             "p",
...
MXNET_OPERATOR_REGISTER_PDF1(dirichlet,
                             PDF_Dirichlet,
                             "alpha",
