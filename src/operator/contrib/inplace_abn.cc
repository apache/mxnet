...
Operator *InplaceABNProp::CreateOperatorEx(Context ctx, std::vector<TShape> *in_shape,
...
Reference:
  .. [1] Bulò, Samuel Rota, Lorenzo Porzi, and Peter Kontschieder. "In-place activated batchnorm for memory-optimized training of DNNs." CVPR (2018).
  .. [2] Ioffe, Sergey, and Christian Szegedy. "Batch normalization: Accelerating
