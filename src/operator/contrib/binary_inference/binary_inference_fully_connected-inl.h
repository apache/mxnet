...
#ifndef MXNET_OPERATOR_BINARY_INFERENCE_FULLY_CONNECTED_INL_H_
#define MXNET_OPERATOR_BINARY_INFERENCE_FULLY_CONNECTED_INL_H_
...
#endif  // MXNET_OPERATOR_BINARY_INFERENCE_FULLY_CONNECTED_INL_H_
