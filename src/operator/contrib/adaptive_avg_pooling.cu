 ...
 */
template <typename T>
__global__ void adaptiveaveragepool(T* input,
                                    T* output,
                                    int isizeH,
                                    int isizeW,
                                    int osizeH,
 ...
 */
template <typename T>
__global__ void atomicadaptiveaveragegradinput(T* gradInput,
                                               T* gradOutput,
                                               int isizeH,
                                               int isizeW,
                                               int osizeH,
...
void AdaptiveAvgPoolUpdateOutput(mshadow::Stream<gpu>* s,
  ...
  adaptiveaveragepool<<<blocks, threads, 0, stream>>>(
      input_data, output_data, isizeH, isizeW, osizeH, osizeW, istrideD, istrideH, istrideW);
