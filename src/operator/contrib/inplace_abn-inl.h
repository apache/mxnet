...
class InplaceABN : public Operator {
 public:
  ...
  virtual void Forward(const OpContext &ctx,
    ...
    Tensor<xpu, 1> slope = in_data[inplaceabn::kGamma].get<xpu, 1, real_t>(s);
    Tensor<xpu, 1> bias = in_data[inplaceabn::kBeta].get<xpu, 1, real_t>(s);
    ...
    if (ctx.is_train && !param_.use_global_stats) {
      ...
      CHECK(req[inplaceabn::kMean] == kNullOp || req[inplaceabn::kMean] == kWriteTo);
      CHECK(req[inplaceabn::kVar] == kNullOp || req[inplaceabn::kVar] == kWriteTo);
      // E(x) and E(x^2)
      ...
      Assign(out, req[inplaceabn::kOut], broadcast<1>(slope, out.shape_) *
             (data - broadcast<1>(mean, data.shape_)) /
             F<mshadow_op::square_root>(broadcast<1>(var + param_.eps, data.shape_)) +
             broadcast<1>(bias, out.shape_));
    } else {
      Assign(out, req[inplaceabn::kOut], broadcast<1>(slope /
  ...
  virtual void Backward(const OpContext &ctx,
    ...
    Tensor<xpu, 1> gslope = in_grad[inplaceabn::kGamma].get<xpu, 1, real_t>(s);
    Tensor<xpu, 1> gbias = in_grad[inplaceabn::kBeta].get<xpu, 1, real_t>(s);
    // update moving avg
    Tensor<xpu, 1> moving_mean = aux_states[inplaceabn::kMovingMean].get<xpu, 1, real_t>(s);
    Tensor<xpu, 1> moving_var = aux_states[inplaceabn::kMovingVar].get<xpu, 1, real_t>(s);
    ...
    if (ctx.is_train && !param_.use_global_stats) {
      ...
      Tensor<xpu, 2> workspace = ctx.requested[inplaceabn::kTempSpace].get_space<xpu>(
      ...
      // assign
      Assign(gslope, req[inplaceabn::kGamma],
             sumall_except_dim<1>(
      ...
      Assign(gbias, req[inplaceabn::kBeta], sumall_except_dim<1>(grad));
    } else {
      ...
      Assign(gbias, req[inplaceabn::kBeta], sumall_except_dim<1>(grad));
      Assign(grad_in, req[inplaceabn::kData], (grad * broadcast<1>(slope, data.shape_)) *
             broadcast<1>(
