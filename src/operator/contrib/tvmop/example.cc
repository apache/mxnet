...
void TVMVectorCompute(const nnvm::NodeAttrs& attrs,
...
static constexpr char func_vmul_cpu[] = "vmul";
...
NNVM_REGISTER_OP(tvm_vector_add)
    ...
    .set_attr<mxnet::FCompute>("FCompute<cpu>", mxnet::op::TVMVectorCompute<func_vadd_cpu>)
    .set_attr<mxnet::FCompute>("FCompute<gpu>", mxnet::op::TVMVectorCompute<func_vadd_gpu>);

NNVM_REGISTER_OP(tvm_vector_mul)
    .set_num_inputs(2)
    .set_num_outputs(1)
    .add_argument("a", "NDArray-or-Symbol", "first input")
    .add_argument("b", "NDArray-or-Symbol", "second input")
    .set_attr<mxnet::FInferShape>("FInferShape", mxnet::op::ElemwiseShape<2, 1>)
    .set_attr<nnvm::FInferType>("FInferType", mxnet::op::ElemwiseType<2, 1>)
    .set_attr<mxnet::FCompute>("FCompute<cpu>", mxnet::op::TVMVectorCompute<func_vmul_cpu>);
