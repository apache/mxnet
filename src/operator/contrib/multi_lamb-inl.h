...
inline void multiLAMB(const nnvm::NodeAttrs& attrs,
  ...
  MSHADOW_REAL_TYPE_SWITCH(inputs[0].type_flag_, DType, {
    ...
    size_t workspace_size = 2 * kernel_params.count * sizeof(float);
    ...
    pos_wspace += kernel_params.count * sizeof(float);
