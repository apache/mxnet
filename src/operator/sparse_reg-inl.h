 ...
 * \brief
*/
#ifndef MXNET_OPERATOR_SPARSE_REG_INL_H_
#define MXNET_OPERATOR_SPARSE_REG_INL_H_
...
namespace sparsereg {
enum SparseRegOpInputs {kData};
enum SparseRegOpOutputs {kOut};
enum SparseRegOpAuxiliary {kMovingAvg};
enum SparseRegBackResource {kTempSpace};
}  // namespace sparsereg

struct SparseRegParam : public dmlc::Parameter<SparseRegParam> {
  float penalty;
  float sparseness_target;
  float momentum;
  DMLC_DECLARE_PARAMETER(SparseRegParam) {
...
};  // struct SparseRegParam

template<typename xpu>
class SparseRegOp : public Operator {
 public:
  explicit SparseRegOp(SparseRegParam param) {
    this->param_ = param;
  }
 ...
 private:
  SparseRegParam param_;
};  // class SparseRegOp

template<typename xpu>
Operator *CreateOp(SparseRegParam param);

#if DMLC_USE_CXX11
class SparseRegProp : public OperatorProperty {
 public:
 ...
 private:
  SparseRegParam param_;
};  // class SparseRegProperty

#endif  // DMLC_USE_CXX11
}  // namespace op
}  // namespace mxnet

#endif  // MXNET_OPERATOR_SPARSE_REG_INL_H_
