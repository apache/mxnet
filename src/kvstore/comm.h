...
class Comm {
 public:
   ...
   */
  virtual void Init(int key, const TShape& shape, const int& dtype) = 0;
  /**
...
class CommCPU : public Comm {
 public:
  ...
  void Init(int key, const TShape& shape, const int& type) override {
...
class CommDevice : public Comm {
 public:
  ...
  void Init(int key, const TShape& shape, const int& dtype) override {
