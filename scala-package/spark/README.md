...
Checkout the [Installation Guide](http://mxnet.incubator.apache.org/get_started) contains instructions to install mxnet. Remember to enable the distributed training, i.e., set `USE_DIST_KVSTORE=1`.
