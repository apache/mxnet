...
1. [Build MXNet](https://mxnet.incubator.apache.org/get_started/ubuntu_setup)
2. [Build MXNet Scala/Java Package](https://mxnet.incubator.apache.org/get_started/scala_setup)
3. [IntelliJ IDE (or alternative IDE) project setup](https://mxnet.incubator.apache.org/tutorials/java/mxnet_java_on_intellij.html) with the MXNet Scala/Java Package
4. wget
