...
def eig(a):
    ...
    >>> w, v = LA.eig(a)
    >>> w
    array([ 6.96830262, -7.76806291, -5.65593851])
    >>> v
    array([[ 0.90617795,  0.95436218,  0.24923088],
           [ 0.13086088, -0.04077049, -0.93256174],
           [ 0.40214047, -0.2958557 ,  0.26117536]])
    """
...
def eigh(a, upper=False):
    ...
    >>> w
    array([-2.17544485, -1.45818207,  7.37254382])
    >>> v
    array([[ 0.18051638, -0.16569254,  0.96951525],
           [ 0.82429364,  0.56326419, -0.05721398],
           [-0.53661329,  0.80949332,  0.23825772]])
    """
    if not upper:
        UPLO = 'L'
    else:
