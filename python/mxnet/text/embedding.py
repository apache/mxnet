...
def create(embedding_name, **kwargs):
    ...
    Returns
    -------
    An instance of `mxnet.contrib.text.glossary.TokenEmbedding`:
...
class TokenEmbedding(object):
    ...
    """
    def __init__(self, unknown_token='<unk>', reserved_tokens=None):
    ...
    @staticmethod
    def from_file(pretrained_file_path, elem_delim=' ', encoding='utf8',
                  init_unknown_vec=nd.zeros, **kwargs):
        """Load user-defined token embedding.
        ...
        embedding._load_embedding(pretrained_file_path, elem_delim, init_unknown_vec, encoding)
