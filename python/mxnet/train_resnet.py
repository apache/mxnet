...
def main():
    numWorker = int(os.environ['DMLC_NUM_WORKER'])
    schedIp = os.environ['DMLC_PS_ROOT_URI']
    schedPort = 29367 + int(os.environ['DMLC_WORKER_ID'])
    #launch connectedspeedometer
    speedometer = mx.callback.ConnectedSpeedometer(args.batch_size,numWorker,schedPort,(schedIp,29367),args.frequent)
    ...
    train = mx.io.ImageRecordIter(
        ...
        part_index          = kv.rank)
    train = mx.io.ResizeIter(train,args.batches)
    ...
    model = mx.model.FeedForward(
        ...
        num_epoch           = 1, #200 if args.data_type == "cifar10" else 120,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--frequent', type=int, default=1, help='frequency of logging')
    ...
    parser.add_argument('--batches', type=int, default=1, help='[In-Network Aggregation]Number of batches to run')
    parser.add_argument('--update-freq', type=int, default=1, help='[In-Network Aggregation]Synchronize param every k batches')
