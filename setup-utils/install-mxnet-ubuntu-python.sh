...
sudo apt-get update
sudo apt-get --no-install-recommends install -y ca-certificates apt-utils build-essential libatlas-base-dev libopencv-dev graphviz
...
sudo apt-get --no-install-recommends install -y ca-certificates apt-utils python-numpy

echo "Installing Python setuptools pip..."
sudo apt-get --no-install-recommends install -y ca-certificates apt-utils python-setuptools python-pip
