...
The following code is an example on how to register an operator (checkout [src/operator/tensor](https://github.com/apache/incubator-mxnet/tree/v1.x/src/operator/tensor) for more examples):
...
- [mxnet/op_attr_types.h](https://github.com/apache/incubator-mxnet/blob/v1.x/include/mxnet/op_attr_types.h)
