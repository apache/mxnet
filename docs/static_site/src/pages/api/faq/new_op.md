...
Please see the full code for this example [here](https://github.com/apache/incubator-mxnet/blob/v1.x/example/numpy-ops/custom_softmax.py).
...
The following code is an example on how to register an operator (checkout [src/operator/tensor](https://github.com/apache/incubator-mxnet/tree/master/src/operator/tensor) for more examples):
...
- [mxnet/op_attr_types.h](https://github.com/apache/incubator-mxnet/blob/master/include/mxnet/op_attr_types.h)
