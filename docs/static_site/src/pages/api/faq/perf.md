...
Besides, we can use [tools/bandwidth](https://github.com/apache/incubator-mxnet/tree/v1.x/tools/bandwidth)
...
See [example/profiler](https://github.com/apache/incubator-mxnet/tree/v1.x/example/profiler)
