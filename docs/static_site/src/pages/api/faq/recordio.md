...
* [im2rec.cc](https://github.com/apache/incubator-mxnet/blob/v1.x/tools/im2rec.cc) - implements the tool using the C++ API.
* [im2rec.py](https://github.com/apache/incubator-mxnet/blob/v1.x/tools/im2rec.py) - implements the tool using the Python API.
