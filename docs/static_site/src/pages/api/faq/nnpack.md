...
# Install Pip
$ sudo apt-get update
$ sudo apt-get --no-install-recommends install -y ca-certificates apt-utils python-pip
...
$ sudo apt-get --no-install-recommends install -y ca-certificates apt-utils ninja-build
