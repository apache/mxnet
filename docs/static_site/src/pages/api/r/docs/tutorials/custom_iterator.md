...
Custom CSV Iterator
----------
Next we are going to create a custom CSV Iterator based on the [C++ CSVIterator class](https://github.com/apache/incubator-mxnet/blob/v1.x/src/io/iter_csv.cc).
