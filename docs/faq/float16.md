...
```
    ...
    Starting training with float16
    Epoch[0] Batch [50]	Speed: 635.617979 samples/sec	accuracy=0.144608
    Epoch[0] Batch [100]	Speed: 638.291621 samples/sec	accuracy=0.164759
    [Epoch 0] training: accuracy=0.166810
    [Epoch 0] time cost: 16.105072
    [Epoch 0] validation: accuracy=0.184414
    Epoch[1] Batch [50]	Speed: 641.935155 samples/sec	accuracy=0.219363
    Epoch[1] Batch [100]	Speed: 640.876137 samples/sec	accuracy=0.230353
    [Epoch 1] training: accuracy=0.232561
    [Epoch 1] time cost: 12.419371
    [Epoch 1] validation: accuracy=0.240928
    Epoch[2] Batch [50]	Speed: 641.412105 samples/sec	accuracy=0.272059
    Epoch[2] Batch [100]	Speed: 640.854717 samples/sec	accuracy=0.278620
    [Epoch 2] training: accuracy=0.276730
    [Epoch 2] time cost: 12.434107
    [Epoch 2] validation: accuracy=0.242713
    Epoch[3] Batch [50]	Speed: 641.651283 samples/sec	accuracy=0.295956
    Epoch[3] Batch [100]	Speed: 640.928163 samples/sec	accuracy=0.301825
    [Epoch 3] training: accuracy=0.304889
    [Epoch 3] time cost: 12.449675
    [Epoch 3] validation: accuracy=0.276621
    Epoch[4] Batch [50]	Speed: 640.678820 samples/sec	accuracy=0.348652
    Epoch[4] Batch [100]	Speed: 638.042808 samples/sec	accuracy=0.343595
    [Epoch 4] training: accuracy=0.343625
    [Epoch 4] time cost: 12.448016
    ...
    Traceback (most recent call last):
      ...
      File "/home/ubuntu/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/process.py", line 93, in run
        self._target(*self._args, **self._kwargs)
      File "/home/ubuntu/anaconda3/envs/mxnet_p36/lib/python3.6/site-packages/mxnet/gluon/data/dataloader.py", line 116, in worker_loop
    ...
    KeyboardInterrupt
    Traceback (most recent call last):
      File "/home/ubuntu/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/queues.py", line 240, in _feed
        send_bytes(obj)
      File "/home/ubuntu/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/connection.py", line 200, in send_bytes
        self._send_bytes(m[offset:offset + size])
      File "/home/ubuntu/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/connection.py", line 404, in _send_bytes
        self._send(header + buf)
      File "/home/ubuntu/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/connection.py", line 368, in _send
    ...
    <ipython-input-11-1a76b82303f4> in <module>()
          1 DTYPE = 'float16'
          2 net = get_network(DTYPE)
    ----> 3 train(net, dtype=DTYPE, num_epochs=25)
    

    <ipython-input-10-291354706928> in train(net, dtype, num_epochs)
         26         print('[Epoch %d] training: %s=%f'%(epoch, name, acc))
         27         print('[Epoch %d] time cost: %f'%(epoch, time.time()-tic))
    ---> 28         name, val_acc = test(net, test_data, dtype)
         29         print('[Epoch %d] validation: %s=%f'%(epoch, name, val_acc))


    <ipython-input-9-f68dd27127d4> in test(net, val_data, dtype)
          1 def test(net, val_data, dtype):
          2     metric.reset()
    ----> 3     for (data, label) in val_data:
          4         data = data.as_in_context(ctx).astype(dtype)
          5         label = label.as_in_context(ctx)


    ~/anaconda3/envs/mxnet_p36/lib/python3.6/site-packages/mxnet/gluon/data/dataloader.py in __iter__(self)
        282         # multi-worker
    ...
    ~/anaconda3/envs/mxnet_p36/lib/python3.6/site-packages/mxnet/gluon/data/dataloader.py in __init__(self, num_workers, dataset, batchify_fn, batch_sampler)
    ...
    ~/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/process.py in start(self)
    ...
    ~/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/context.py in _Popen(process_obj)
        221     @staticmethod
    ...
    ~/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/popen_fork.py in __init__(self, process_obj)
         24             pass
         25         self.returncode = None
    ---> 26         self._launch(process_obj)
         27 
         28     def duplicate_for_child(self, fd):


    ~/anaconda3/envs/mxnet_p36/lib/python3.6/multiprocessing/popen_fork.py in _launch(self, process_obj)
         71         code = 1
