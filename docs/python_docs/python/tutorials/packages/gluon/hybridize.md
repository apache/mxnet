...
There are however several operators that can help you with array manipulations like: [`F.split`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.split.html#mxnet.ndarray.split), [`F.slice`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.slice.html#mxnet.ndarray.slice), [`F.take`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.take.html),[`F.pick`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.pick.html), [`F.where`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.where.html), [`F.reshape`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.reshape.html) or [`F.reshape_like`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.reshape_like.html).
...
There are also a lot of operators that support special indices to help with most of the use-cases where you would want to access the shape information. For example, `F.reshape(x, (0,0,-1))` will keep the first two dimensions unchanged and collapse all further dimensions into the third dimension. See the documentation of the [`F.reshape`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.reshape.html) for more details.
...
Direct item assignment is not possible in symbolic graph since it needs to be part of a computational graph. One way is to use add more inputs to your graph and use masking or the [`F.where`](https://beta.mxnet.io/api/ndarray/_autogen/mxnet.ndarray.where.html) operator.
