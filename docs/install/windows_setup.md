...
4. Click "Browse Source" button and navigate to folder where MXNet source is downloaded. For example -"<github_parent_dir>/GitHub/incubator-mxnet"
...
8. Choose appropriate generator, for example Visual Studio 15 2017 Win64, if building for x64 
