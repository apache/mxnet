...
You can get the source code for below example [here](https://github.com/dmlc/mxnet/tree/master/example/image-classification)

This folder contains examples for image classifications. In this task, we assign
