...
To install for other platforms (e.g. Raspberry Pi/ARM) or other versions of CUDA, check [Installing MXNet](https://mxnet.apache.org/get_started?environ=build-from-source) for instructions on building from source.
