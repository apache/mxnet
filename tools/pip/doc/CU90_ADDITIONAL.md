...
To install for other platforms (e.g. Windows, Raspberry Pi/ARM) or other versions, check [Installing MXNet](https://mxnet.apache.org/get_started?environ=build-from-source) for instructions on building from source.
