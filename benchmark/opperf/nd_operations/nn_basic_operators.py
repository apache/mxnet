...
def run_nn_basic_operators_benchmarks(ctx=mx.cpu(), dtype='float32', profiler='native', warmup=25, runs=100):
    ...
    lrn_benchmark_res = run_performance_test([getattr(MX_OP_MODULE, "LRN")],
                                                   ...
                                                   warmup=warmup,
                                                   runs=runs)
    # preloaded_multi_mp_sgd_mom_update benchmarks
    pmmsmu_benchmark_res = run_performance_test([getattr(MX_OP_MODULE, "preloaded_multi_mp_sgd_mom_update")],
                                                   run_backward=True,
                                                   dtype=dtype,
                                                   ctx=ctx,
                                                   profiler=profiler,
