...
def prepare_workloads():
    ...
    OpArgMngr.add_workload("copy", pool['2x2'])
    OpArgMngr.add_workload("reshape", pool['2x2'], -1)
    OpArgMngr.add_workload("ravel", pool['2x2'])
    OpArgMngr.add_workload("moveaxis", pool['2x2'], 1, 0)
