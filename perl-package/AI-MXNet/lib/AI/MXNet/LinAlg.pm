...
=head1 DESCRIPTION
    ...
    L<NDArray Python Docs|https://mxnet.incubator.apache.org/api/python/ndarray/linalg.html>
    L<Symbol Python Docs|https://mxnet.incubator.apache.org/api/python/symbol/linalg.html>
