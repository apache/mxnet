...
Besides Caffe, MXNet has already embedded Torch modules and its tensor mathematical functions. ([link](https://github.com/apache/incubator-mxnet/blob/master/docs/faq/torch.md))
