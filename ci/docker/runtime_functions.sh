...
sanity_cpp() {
    set -ex
    3rdparty/dmlc-core/scripts/lint.py mxnet cpp include src plugin tests --exclude_path src/operator/contrib/ctc_include include/mkldnn src/serialization/miniz.cc
}
