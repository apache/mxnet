...
cd_unittest_ubuntu() {
    ...
    pytest -n 4 --durations=50 --verbose tests/python/unittest
    ...
    if [[ ${mxnet_variant} = cu* ]]; then
        pytest -n 4 --durations=50 --verbose tests/python/gpu
...
unittest_ubuntu_python3_cpu() {
    ...
    export MXNET_ENABLE_CYTHON=0
    export DMLC_LOG_STACK_TRACE_DEPTH=10
    pytest -n 4 --durations=50 --cov-report xml:tests_unittest.xml --verbose tests/python/unittest
...
unittest_centos7_cpu() {
    ...
    source /opt/rh/rh-python36/enable
    cd /work/mxnet
    python -m pytest -n 4 --durations=50 --cov-report xml:tests_unittest.xml --verbose tests/python/unittest
...
test_ubuntu_cpu_python3() {
    ...
    pip3 install -e .
    cd /work/mxnet
    python3 -m pytest -n 4 --durations=50 --verbose tests/python/unittest
