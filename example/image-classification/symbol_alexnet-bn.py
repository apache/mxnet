...
def get_symbol(num_classes = 1000):
    ...
    bn_fc1 = mx.symbol.BatchNorm(data=fc1, name='nb_fc1')
    relu6 = mx.symbol.Activation(data=bn_fc1, act_type="relu")
    dropout1 = mx.symbol.Dropout(data=relu6, p=0.5)
    # stage 5
    fc2 = mx.symbol.FullyConnected(data=dropout1, num_hidden=4096)
    nb_fc2= mx.symbol.BatchNorm(data=fc2, name='nb_fc2')
    relu7 = mx.symbol.Activation(data=nb_fc2, act_type="relu")
