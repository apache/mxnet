...
def vgg_conv_deconv(input_data, num_classes, fix_gamma=False, eps=0.00002,
    ...
    # group 4
    conv4_1 = mx.symbol.Convolution(data=encdrop3, kernel=(3, 3), pad=(1, 1), num_filter=512,
                                    name="conv4_1")
    ...
    # group 5
    conv5_1 = mx.symbol.Convolution(data=encdrop4, kernel=(3, 3), pad=(1, 1), num_filter=512,
                                    name="conv5_1")
    ...
    encdrop5 = mx.sym.Dropout(data=pool5[0], p=0.5, name="encdrop5")
    # deconve
    # group 5
    pool5_d = mx.symbol.UpSamplingMask(data=encdrop5, mask=pool5[1],
    ...
    decdrop5 = mx.sym.Dropout(data=relu5_1_d, p=0.5, name="decdrop5")
    # group 4
    pool4_d = mx.symbol.UpSamplingMask(data=decdrop5, mask=pool4[1],
    ...
    decdrop4 = mx.sym.Dropout(data=relu4_1_d, p=0.5, name="decdrop4")
    # group 3
    ...
    decdrop3 = mx.sym.Dropout(data=relu3_1_d, p=0.5, name="decdrop3")
    # group 2
