...
If you have a tutorial idea for the website, download the [Jupyter notebook tutorial template](https://github.com/apache/incubator-mxnet/tree/v1.x/example/MXNetTutorialTemplate.ipynb).
...
* [MXNet JNI](https://github.com/apache/incubator-mxnet/tree/v1.x/amalgamation/jni) - JNI(Android) library
* [MXNet Amalgamation](https://github.com/apache/incubator-mxnet/tree/v1.x/amalgamation) - Amalgamation (entire library in a single file)
...
* [Faster R-CNN in MXNet with distributed implementation and data parallelization](https://github.com/apache/incubator-mxnet/tree/v1.x/example/rcnn)
