...
If you have a tutorial idea for the website, download the [Jupyter notebook tutorial template](https://github.com/apache/incubator-mxnet/tree/master/example/MXNetTutorialTemplate.ipynb).
