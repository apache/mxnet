...
{
    public class Conv2DLSTMCell : _ConvRNNCell
    {
        public Conv2DLSTMCell(Shape input_shape, int hidden_channels, (int, int) i2h_kernel, (int, int) h2h_kernel, (int, int)? i2h_pad = null,
