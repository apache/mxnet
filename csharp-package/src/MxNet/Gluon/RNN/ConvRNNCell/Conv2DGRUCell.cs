...
{
    public class Conv2DGRUCell : _ConvRNNCell
    {
        public Conv2DGRUCell(Shape input_shape, int hidden_channels, (int, int) i2h_kernel, (int, int) h2h_kernel, (int, int)? i2h_pad = null,
