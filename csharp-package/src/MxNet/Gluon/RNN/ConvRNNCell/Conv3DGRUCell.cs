...
{
    public class Conv3DGRUCell : _ConvRNNCell
    {
        public Conv3DGRUCell(Shape input_shape, int hidden_channels, (int, int, int) i2h_kernel, (int, int, int) h2h_kernel, (int, int, int)? i2h_pad = null,
