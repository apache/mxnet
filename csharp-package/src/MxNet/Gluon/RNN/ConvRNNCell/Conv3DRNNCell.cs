...
{
    public class Conv3DRNNCell : _ConvRNNCell
    {
        public Conv3DRNNCell(Shape input_shape, int hidden_channels, (int, int, int) i2h_kernel, (int, int, int) h2h_kernel, (int, int, int)? i2h_pad = null,
