...
namespace MxNet.AMP
{
    public class SymbolBf16
    {
        public static List<string> BF16_FUNCS = new List<string> {
            "Convolution",
            "FullyConnected"
        };

        public static List<string> BF16_FP32_FUNCS = new List<string> {
            "abs",
            "_add",
            "BatchNorm",
            "BatchNormWithReLU",
        ...
        public static Dictionary<string, List<string>> BF16_USE_FP32_PARAMS = new Dictionary<string, List<string>> {
            {
                "BatchNormWithReLU",
                new List<string> {
                    "",
        ...
        public static List<string> FP32_FUNCS = new List<string> {
            "Deconvolution",
            "RNN",
            "BilinearSampler",
            "BlockGrad",
        ...
        public static List<(string, string, List<string>)> CONDITIONAL_FP32_FUNCS = new List<(string, string, List<string>)> {
            ("Activation", "act_type", new List<string> {
                "softrelu"
            }),
            ("LeakyReLU", "act_type", new List<string> {
                "elu",
                "selu"
            })
        };

        public static List<string> WIDEST_TYPE_CASTS = new List<string> {
            "_Plus",
            "_plus",
            "_Minus",
            "_sub",
        ...
        public static List<object> LOSS_OUTPUT_FUNCTIONS = new List<object>();
    }
}
