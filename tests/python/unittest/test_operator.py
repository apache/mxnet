...
def test_laop_3():
    ...
    def check_bw(sym, location, out_grads, expected): return \
...
def test_laop_4():
    ...
    def check_fw(sym, location, expected, dtype): return \
        check_symbolic_forward(sym, location, expected, rtol=rtol_fw,
                               atol=atol_fw, dtype=dtype)
