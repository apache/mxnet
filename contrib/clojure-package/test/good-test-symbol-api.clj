...
(defn
 activation
 ([nil-or-sym string string-1 kwargs-map]
  (util/coerce-return
   (SymbolAPI/Activation
    (util/nil-or-coerce-param
     (util/->option nil-or-sym)
     #{"scala.Option"})
    (util/nil-or-coerce-param string #{"java.lang.String"})
    (util/nil-or-coerce-param string-1 #{"java.lang.String"})
    (util/nil-or-coerce-param
     kwargs-map
