...
You can find the source code for two callback functions from [here](https://github.com/apache/incubator-mxnet/blob/v1.x/R-package/R/callback.R) and they can be used as your template:
