...
#' 
#' @export
mx.symbol.CuDNNBatchNorm <- function(...) {
  mx.varg.symbol.CuDNNBatchNorm(list(...))
}
...
#' @param target.shape  Shape(tuple), optional, default=()
...
#' 
#' @export
mx.symbol.sum_mid_internal <- function(...) {
  mx.varg.symbol.sum_mid_internal(list(...))
}
