...
if(BLAS MATCHES "[Aa][Tt][Ll][Aa][Ss]")
  ...
  list(APPEND mxnet_LINKER_LIBS ${Atlas_LIBRARIES} PARENT_SCOPE)
...
if(BLAS MATCHES "[Oo][Pp][Ee][Nn]")
  ...
  list(APPEND mxnet_LINKER_LIBS ${OpenBLAS_LIBRARIES} PARENT_SCOPE)
...
if(BLAS MATCHES "[Mm][Kk][Ll]")
  ...
  list(APPEND mxnet_LINKER_LIBS ${MKL_LIBRARIES} PARENT_SCOPE)
...
if(BLAS MATCHES "([Aa][Pp][Pp][Ll][Ee]|[Aa][Cc][Cc][Ee][Ll][Ee][Rr][Aa][Tt][Ee])")
  ...
  list(APPEND mxnet_LINKER_LIBS ${Accelerate_LIBRARIES} PARENT_SCOPE)
