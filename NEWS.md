...
To allow for backward compatibility and to fix this breaking change, `save_params` and `load_params` have been reverted to the previous behavior as available in v1.1.0.
