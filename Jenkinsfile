...
mx_cmake_mkldnn_lib = 'build/libmxnet.so, build/libmxnet.a, build/dmlc-core/libdmlc.a, build/tests/mxnet_unit_tests, build/3rdparty/openmp/runtime/src/libomp.so, 3rdparty/mkldnn/src/libmkldnn.so, 3rdparty/mkldnn/src/libmkldnn.so.0'
