    ...
    node('linux') {
      ws('workspace/ut-r-cpu') {
        ...
        timeout(time: max_time, unit: 'MINUTES') {
          ...
          sh "${docker_run} cpu make rpkgtest USE_BLAS=openblas R_LIBS=/workspace/ut-r-cpu/site-library"
        }
      }
    }
  },
    ...
    node('GPU' && 'linux') {
      ws('workspace/ut-r-gpu') {
        ...
        timeout(time: max_time, unit: 'MINUTES') {
          ...
          sh "${docker_run} gpu make rpkgtest USE_BLAS=openblas R_LIBS=/workspace/ut-r-gpu/site-library"
        }
      }
    }
  },  
