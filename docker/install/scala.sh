...
apt-get --no-install-recommends install -y ca-certificates apt-utils oracle-java8-installer
apt-get --no-install-recommends install -y ca-certificates apt-utils oracle-java8-set-default
